...
const ResumeCategoryCard = (categoryName) => {
    ...
    return (
        <div className=' card-container m-4 flex '>
            <div className='image-container text-center flex items-center justify-center rounded-xl bg-[#669b81] w-[200px] h-[120px] sm:w-[250px] md:w-[300px] md:h-[180px] shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110'>
                <div className='text text-xl md:text-2xl lg:text-3xl text-[#ffffff] font-medium '>
