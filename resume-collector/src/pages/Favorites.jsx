    ...
    return (
        <div className="favorite">            
            ...
            <div className="head mx-auto ">
                <h1 className="title text-xl md:text-5xl text-center flex justify-center items-center m-6">{thai_favoritetitle}</h1>
            <div className="flex justify-center items-center">
            <img className="h-20 w-20 mx-4 md:h-[96px] md:w-[96px] rounded-3xl" src={mainuser.photoURL} alt="" />
            <h1 className="username text-[#ffffff] text-center text-2xl sm:text-5xl font-semibold mr-3 p-4 bg-[#9793CD] rounded-2xl">{mainuser.displayName} Favorites</h1>
            </div>
            </div>
            ):(
